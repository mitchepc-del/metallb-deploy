pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/mitchepc-del/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('mitchepc-225')   // <---- Change this to match your kubernetes cluster credentials
    }
